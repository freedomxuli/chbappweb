...
function dataBind() {
    CS("CZCLZ.Module.GetModuleTreeByPC", function (ret) {
                    ...
                    buttons: [
                        {
                            ...
                            handler: function () {
                                ...
                                if (form.form.isValid()) {
                                    ...
                                    CS('CZCLZ.Module.SaveModuleByPC', function (retVal) {
                                        if (retVal) {
...
function DeleteMK(moduleId) {
    CS('CZCLZ.Module.DeleteModuleByPC', function (retVal) {
        if (retVal) {
                    ...
                    buttons: [
                        {
                            ...
                            handler: function () {
                                ...
                                if (form.form.isValid()) {
                                    var values = form.form.getValues(false);
                                    CS('CZCLZ.Module.SaveMenuByPC', function (retVal) {
                                        if (retVal) {
...
function DeleteMenu(menuId) {
    CS('CZCLZ.Module.DeleteMenuByPC', function (retVal) {
        if (retVal) {
                    ...
                    buttons: [
                        {
                            ...
                            handler: function () {
                                ...
                                if (form.form.isValid()) {
                                    var values = form.form.getValues(false);
                                    CS('CZCLZ.Module.SavePrivilegeByPC', function (retVal) {
                                        if (retVal) {
...
function DeletePrivilege(privilegeId) {
    CS('CZCLZ.Module.DeletePrivilegeByPC', function (retVal) {
        if (retVal) {
