...
//-----------------------------------------------------------页面方法-----------------------------------------------------------------
function getTj() {
    CS('CZCLZ.CWBBMag.GetZshbTj', function (retVal) {
        if (retVal) {
                            ...
                            items: [
                                {
                                    ...
                                    text: '导出',
                                    handler: function () {
                                        if (privilege("财务报表_赠送红包统计_导出")) {
                                            DownloadFile("CZCLZ.CWBBMag.GetZshbTjLineToFile", "赠送红包统计.xls", Ext.getCmp("cx_beg").getValue(), Ext.getCmp("cx_end").getValue(), Ext.getCmp("cx_city").getValue());
                                        }
                                    }
                                }
                            ]
