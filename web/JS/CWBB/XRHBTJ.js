...
function getList(nPage) {
    CS('CZCLZ.CWBBMag.GetXrhbTjLine', function (retVal) {
        tjStore.setData({
            data: retVal.dt,
            pageSize: pageSize,
            total: retVal.ac,
                            ...
                            items: [
                                {
                                    ...
                                    text: '导出',
                                    handler: function () {
                                        if (privilege("财务报表_新人红包统计_导出")) {
                                            DownloadFile("CZCLZ.CWBBMag.GetXrhbTjLineToFile", "新人红包统计.xls", Ext.getCmp("cx_beg").getValue(), Ext.getCmp("cx_end").getValue(), Ext.getCmp("cx_city").getValue());
                                        }
                                    }
                                }
                            ]
