                            ...
                            CS('CZCLZ.CYMag.QRMM', function (retVal) {
                                if (retVal) {
                                    if (type == 0) {
                                        ...
                                        CS('CZCLZ.CYMag.YSFDK', function (ret) {
                                            if (ret) {
                                                DataBind(1);
                                                Ext.MessageBox.alert('提示', "打款成功！");
                                            }
                                        ...
                                        CS('CZCLZ.CYMag.XJDK1', function (ret) {
                                            if (ret) {
                                                DataBind(1);
                                        ...
                                        CS('CZCLZ.CYMag.YSFDK1', function (ret) {
                                            if (ret) {
                                                DataBind(1);
                                    ...
                                    items: [
                                        {
                                            ...
                                            handler: function () {
                                                if (privilege("承运模块_专线承运单查询_导出")) {
                                                    DownloadFile("CZCLZ.CYMag.GetCYDListToFile", "承运单.xls", Ext.getCmp("cx_carriagecode").getValue(), Ext.getCmp("cx_UserXM").getValue(), Ext.getCmp("cx_beg").getValue(), Ext.getCmp("cx_end").getValue(), Ext.getCmp("cx_isinvoice").getValue(), Ext.getCmp("cx_carriagestatus").getValue(), Ext.getCmp("cx_ismoneypay").getValue());
                                                }
                                            }
                                        }
                                    ]
