                                    ...
                                    items: [
                                        {
                                            ...
                                            text: '导出',
                                            handler: function () {
                                                DownloadFile("CZCLZ.YKMag.GetYkxhLineToFile", "油卡订单.xls", zxid, rq, 1);
                                            }
                                        }
                                    ]
                                }
                                    ...
                                    items: [
                                        {
                                            ...
                                            text: '导出',
                                            handler: function () {
                                                DownloadFile("CZCLZ.YKMag.GetYkhbLineToFile", "油卡划拨.xls", zxid, rq, 1);
                                            }
                                        }
                                    ]
                                }
                            ...
                            dockedItems: [
                                {
                                    ...
                                    items: [
                                        ...
                                        },
                                        {
                                            ...
                                            text: '导出',
                                            handler: function () {
                                                DownloadFile("CZCLZ.YKMag.GetLineToFile", "专线油卡明细.xls", zxid, Ext.getCmp('ny').getValue(), 1);
                                            }
                                        }
                                    ]
                                }
