...
function getList(nPage) {
    CS('CZCLZ.XJMag.GetCZTkshList', function (retVal) {
        cardStore.setData({
            data: retVal.dt,
            pageSize: pageSize,
            total: retVal.ac,
...
function getListEXCELOUT(nPage) {
    ...
    DownloadFile("CZCLZ.XJMag.GetCZTkshListOutList", "充值退款数据下载.xls", {
        'cx_beg': Ext.getCmp("cx_beg").getValue(),
        'cx_end': Ext.getCmp("cx_end").getValue(),
        'cx_fhrzh': Ext.getCmp("cx_fhrzh").getValue(),
        'cx_zxmc': Ext.getCmp("cx_zxmc").getValue(),
                ...
                buttons: [
                    {
                        ...
                        iconCls: 'dropyes',
                        handler: function () {
                            CS('CZCLZ.XJMag.CZVerifyPassWorld', function (retVal) {
                                if (retVal) {
                                    getList(1);
