...
function DataBind(nPage) {
    CS('CZCLZ.ThreeClass.GetThreeXFgmmxLIST', function (retVal) {
        store.setData({
            data: retVal.dt,
            pageSize: pageSize,
            total: retVal.ac,
...
function getListEXCELOUT(nPage) {
    ...
    DownloadFile("CZCLZ.ThreeClass.GetThreeXFgmmxOutLIST", "三方消费明细表.xls", Ext.getCmp("a").getValue(), Ext.getCmp("b").getValue(), Ext.getCmp("c").getValue(), Ext.getCmp("cx_beg").getValue(), Ext.getCmp("cx_end").getValue());
