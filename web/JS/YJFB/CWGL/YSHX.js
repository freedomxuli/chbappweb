...
function getUser(nPage) {
    CS('CZCLZ.YSHXByMySql.GYSHXList', function (retVal) {
        orderstore.setData({
            data: retVal.dt,
            pageSize: pageSize,
            total: retVal.ac,
                                        ...
                                        columns: [
                                            {
                                            ...
                                            },
                                              {
                                              ...
                                              },
                                                {
                                                    ...
                                                    text: '已核销金额',
                                                    renderer: function (value, cellmeta, record, rowIndex, columnIndex, store) {
                                                        return record.data.verifymoney;
                                                    }
                                                }, {
                                                    xtype: 'gridcolumn',
                                                    dataIndex: 'shippingnoteid',
                                                    ...
                                                    text: '未核销金额',
                                                    renderer: function (value, cellmeta, record, rowIndex, columnIndex, store) {
                                                        return record.data.actualcompanypay - record.data.verifymoney;
                                                    }
                                                }, {
                                                    xtype: 'gridcolumn',
                                                    dataIndex: 'shippingnoteid',
                                                ...
                                                },
                                                 {
                                                    ...
                                                    text: '核销记录',
                                                    renderer: function (value, cellmeta, record, rowIndex, columnIndex, store) {
                                                        return "<div style='color:green;cursor:pointer;' onclick='CKHXJL(\"" + value + "\",\"" + record.data.username + "\",\"" + record.data.actualcompanypay + "\",\"" + record.data.userid + "\")'>查看</div>"; 
                                                    }
                                                }, {
                                                    xtype: 'gridcolumn',
                                                    dataIndex: 'shippingnoteid',
                                                    ...
                                                    text: '操作',
                                                    renderer: function (value, cellmeta, record, rowIndex, columnIndex, store) {
                                                        return "<div style='color:green;cursor:pointer;' onclick='AddPJ(\"" + value + "\",\"" + record.data.username + "\",\"" + record.data.actualcompanypay + "\",\"" + record.data.userid + "\",\"" + record.data.verifymoney + "\",\"" + record.data.offerid + "\")'>单独核销</div>";
                                                    }
                                                }
                                                ...
                                                items: [
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        handler: function () {
                                                            ...
                                                            var gys = "";
                                                            var actualcompanypay = 0;
                                                            for (var n = 0, len = rds.length; n < len; n++) {
                                                                var rd = rds[n];
                                                                gys += rd.get("username") + ",";
                                                                idlist.push(rd.get("shippingnoteid") + "," + rd.get("userid") + "," + rd.get("offerid") + "," + rd.get("actualcompanypay") + "," + rd.get("verifymoney") + "," + rd.get("username"));
                                                               
                                                                actualcompanypay += (rd.get("actualcompanypay") - rd.get("verifymoney"))
                                                            }
               ...
               buttons: [
                   {
                       ...
                       handler: function () {
                           ...
                           Ext.MessageBox.confirm("提示", "总共核销金额" + actualcompanypay + "元，是否核销？", function (obj) {
                               if (obj == "yes") {
...
function AddPJ(notepid, username, actualcompanypay, userid, verifymoney, offerid) {
               ...
               items: [
                    {
                     ...
                     {
                         xtype: 'label',
                         text: '核销总金额：' + actualcompanypay + ",已核销总金额：" + verifymoney + ",剩余可核销金额：" + (actualcompanypay - verifymoney),
                           ...
                           Ext.MessageBox.confirm("提示", "是否确认核销？", function (obj) {
                               if (obj == "yes") {
                                   ...
                                   if (form.form.isValid()) {
                                       ...
                                       }, CS.onError, values, notepid, userid, username,(actualcompanypay - verifymoney), actualcompanypay, offerid);
...
function LookP(userid, actualmoney) {
    ...
    CS('CZCLZ.YSHXByMySql.GetUserMX', function (retVal) {
        if (retVal.length > 0) {
            var item = retVal[0];
...
function LookDD(shippingnotenumber, actualmoney) {
    ...
    CS('CZCLZ.YSHXByMySql.GetDDMX', function (retVal) {
        if (retVal.length > 0) {
            var item = retVal[0];
...
function getStartOREnd(shippingnoteid) {
    ...
    CS('CZCLZ.YSHXByMySql.GetHXLIST', function (retVals) {
            if (retVals.length > 0) {
